...
## Definition of done (`.ai/constitution/agent-behavior.md`와 `docs/product/goals.md` 기준)
...
코드가 컴파일된다는 사실만으로는 완료의 충분한 증거가 되지 않는다 — `.ai/constitution/agent-behavior.md` 참고.
